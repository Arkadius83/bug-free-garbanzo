...
const api: StudioApi = {
  ...
  listArtistPromotionProfiles: () => ipcRenderer.invoke("studio:list-artist-promotion-profiles"),
  getArtistPromotionProfile: (artistId) => ipcRenderer.invoke("studio:get-artist-promotion-profile", artistId),
  updateArtistPromotionProfile: (input) => ipcRenderer.invoke("studio:update-artist-promotion-profile", input),
