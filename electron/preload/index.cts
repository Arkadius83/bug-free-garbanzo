...
const api: StudioApi = {
  ...
  reviewPublishingQueueItem: (input) => ipcRenderer.invoke("studio:review-publishing-queue-item", input).catch(() => Promise.reject(new Error("Review not consolidated â€” UI disabled"))),
  ...
  generatePromoContent: (input) => ipcRenderer.invoke("studio:generate-promo-content", input).catch(() => Promise.reject(new Error("Promo generation not consolidated â€” UI disabled"))),
  ...
  createScheduleEvent: (input) => ipcRenderer.invoke("studio:create-schedule-event", input).catch(() => Promise.reject(new Error("Schedule events not consolidated â€” UI disabled"))),
