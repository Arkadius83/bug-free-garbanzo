...
export function createMockStudio(overrides?: Partial<StudioApi>): MockStudio {
  return {
    ...
    sendScheduleEventToPublishingQueue: async (id) => ({ scheduleEvent: mockScheduleEvent({ id, publishingQueueId: "queue-1", queuedAt: "2026-09-15T12:00:00Z", queuedBy: "local-user" }), publishingQueueItem: { id: "queue-1", sourceType:"release",sourceId:"release-1",sourceTitle:"Different Perspective", releaseId: "release-1", releaseTitle: "Different Perspective", campaignPackItemId: "pack-1", eventId:null,eventName:null,eventCampaignItemId:null, platform: "Instagram", mediaGenerationId: null, caption: "Approved copy", scheduledAt: "2026-10-01T16:00:00.000Z", status: "draft", error: null, exportedAt: null, remotePostId: null, publishedAt: null, destinationId: null, mediaType: null, mediaProvider: null, rightsBlocked: false,sourceScheduleEventId:id,sourceCampaignItemTitle:"Announcement",reviewedBy:null,reviewedAt:null,reviewReason:null, createdAt: "2026-09-15T12:00:00Z", updatedAt: "2026-09-15T12:00:00Z" } }),
    enqueueEventCampaignItem: async (id) => ({id:"event-queue-1",sourceType:"event",sourceId:"event-1",sourceTitle:"Sonic Ark Night",releaseId:null,releaseTitle:"Sonic Ark Night",campaignPackItemId:null,eventId:"event-1",eventName:"Sonic Ark Night",eventCampaignItemId:id,platform:"Facebook",mediaGenerationId:null,caption:"Approved event copy",scheduledAt:"2026-10-01T18:00:00.000Z",status:"draft",error:null,exportedAt:null,remotePostId:null,publishedAt:null,destinationId:null,mediaType:null,mediaProvider:null,rightsBlocked:false,sourceScheduleEventId:null,sourceCampaignItemTitle:"Event announcement",reviewedBy:null,reviewedAt:null,reviewReason:null,createdAt:"2026-09-15T12:00:00Z",updatedAt:"2026-09-15T12:00:00Z"}),
    ...overrides
  } as MockStudio;
}
